...
export const SOURCE_AUTHORITIES = Object.freeze({
  "docs/agent-control/context-packets/067-wo055a-sql-bridge-fail-closed-closure.md": Object.freeze({
    sha256: "c9d87796396cd61a5b18faeabc724e7b7c379af71bacc1b02a01411a163b581a",
    authorities: Object.freeze(["artifact", "reviewer", "tool"]),
  }),
  "docs/agent-control/context-packets/068-wo055a-typescript-task-reselection.md": Object.freeze({
    sha256: "277847e09e8b5f6f2d139b1346846a68b3f122011cf3b7ebcf5fd1a43d689ae5",
    authorities: Object.freeze(["artifact", "reviewer", "tool"]),
  }),
  "docs/agent-control/context-packets/069-wo055a-typescript-reselection-receipt-remediation.md": Object.freeze({
    sha256: "56072fb86f0368947e6fb6ca9b6de49b7a4b1c94f333a1972ec09446f94ad375",
    authorities: Object.freeze(["artifact", "reviewer", "tool"]),
  }),
  "docs/agent-control/context-packets/070-maintained-analysis-state-spike.md": Object.freeze({
    sha256: "fc0673eabbbed9a881bd94a8fcd701b1b6f8e2986c098023a32daea4b5d256e7",
    authorities: Object.freeze(["artifact", "manager", "reviewer", "tool"]),
  }),
  "docs/superpowers/plans/2026-08-30-maintained-analysis-state.md": Object.freeze({
    sha256: "a9a262421e12c2aa3b5f321dfd8c79d2774b568de4e4b9e00a5a58381f5b92ac",
    authorities: Object.freeze(["test"]),
  }),
});

export const ALLOWED_SOURCE_PATHS = Object.freeze(Object.keys(SOURCE_AUTHORITIES).sort());
...
function validateObservation(observation) {
  ...
  const sourceAuthority = SOURCE_AUTHORITIES[observation.source.path];
...
function validateInput(input, authorityManifest) {
...
export class AnalysisState {
  ...
  constructor(input, authorityManifest) {
    this.#replace(input, authorityManifest, true);
  }

  #replace(input, authorityManifest, initial) {
    const observations = validateInput(input, authorityManifest);
...
export function evaluateAnalysisState(input, authorityManifest) {
  return new AnalysisState(input, authorityManifest);
}
