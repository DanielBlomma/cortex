...
- The diverged histories independently allocated WO-056 through WO-058. The
  ...
  branch-local IDs. Its risk is qualified as R20-HARNESS; dialect runtime
  packaging retains R20.
...
- The stable evidence locator is
  ...
  2.5.2 state.
## 2026-08-27 — DeepSeek Harness V1 pre-release state
...
## 2026-08-25 — WO-B and WO-C acceptance history
